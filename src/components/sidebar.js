                ...
                <div>
                    ...
                    <aside id="colorlib-aside" className="border js-fullheight">
                        <div className="text-center">
                            <div className="author-img" style={{backgroundImage: 'url(images/profile-pic-2.jpg)'}}/>
                            <h1 id="colorlib-logo"><a href="/">Ritesh Goyal</a></h1>
                            <span className="email"><i className="icon-mail"/>goyalritesh21@gmail.com</span>
                        </div>
                        ...
                        <nav id="colorlib-main-menu">
                            <ul>
                                <li><a href="https://github.com/goyalritesh21" target="_blank"
                                       rel="noopener noreferrer"><i className="icon-github"/></a></li>
                                <li><a href="https://www.linkedin.com/in/goyalritesh21/" target="_blank"
                                       rel="noopener noreferrer"><i className="icon-linkedin2"/></a></li>
                                <li><a href="https://www.facebook.com/goyalritesh21/" target="_blank"
                                       rel="noopener noreferrer"><i className="icon-facebook2"/></a></li>
                                <li><a href="https://www.instagram.com/goyalritesh21/" target="_blank"
                                       rel="noopener noreferrer"><i className="icon-instagram"/></a></li>
                                <li><a href="https://twitter.com/goyalritesh21/" target="_blank"
